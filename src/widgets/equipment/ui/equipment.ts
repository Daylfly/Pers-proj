    ...
    laboratory: [
        {
            ...
            features: ["Высокая точность", "быстрые результаты"],
        },
        {
            ...
            features: ["Полный анализ за 60 секунд"],
        },
    ],
    ...
    rehabilitation: [
        {
            ...
            features: ["Многофункциональная терапия"],
        },
        {
